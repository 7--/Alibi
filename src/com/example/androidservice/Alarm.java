...
public class Alarm extends BroadcastReceiver {
	...
	public void getLoc(final Context context, final String uniqueid) {
		LocationResult locationResult = new LocationResult() {@Override
			public void gotLocation(Location location) {
				Log.v("Alarm.java", "Trying to get location");
				tries++;
				if (location != null) {
					successes++;
					Log.v("Alarm", "Found location");

					Log.v("Alarm", "UID: "+session.getUID());
		...
		if (gotL == false) Log.v("Alarm.java", "can't find location");
	}
